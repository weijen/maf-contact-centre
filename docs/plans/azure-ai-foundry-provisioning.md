...
## Problem Statement
Provision an Azure AI Foundry project named `maf-contact-centre` with a GPT-5.3-chat model deployment and Application Insights for observability. Subscription: `<your-azure-subscription-id>`.
...
4. **GPT-5.3-chat Model Deployment** — deployed within the AI project
...
- `model-deployment`: Deploy GPT-5.3-chat model (depends on ai-project)
...
- **GPT-5.3-chat deployment**: GlobalStandard SKU (pay-per-use, no reserved capacity)
- **Environment tag**: `dev`
